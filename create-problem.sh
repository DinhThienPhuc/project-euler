...
echo "const main = () => {" >>problems/$1/answer.js
echo "console.log()" >>problems/$1/answer.js
echo "}" >>problems/$1/answer.js
...
echo "const main = () => {" >>problems/$1/solution.js
echo "console.log()" >>problems/$1/solution.js
echo "}" >>problems/$1/solution.js
